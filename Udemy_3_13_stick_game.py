...
def stick():
    ...
    name2 = input()
    print('Введите количество палочек для игроков')
    totalstick = int(input())
    while totalstick > 0:
        print('Сейчас ходит', name1)
        print('На столе лежит', totalstick, 'палочек')
        print('Введите, сколько палочек вы хотите взять')
        wannatake = int(input())
        totalstick = totalstick - wannatake
        if totalstick <= 0:
            print("Победил ", name2)
            break
        print('Сейчас ходит', name2)
        print('На столе лежит', totalstick, 'палочек')
        print('Введите, сколько палочек вы хотите взять')
        wannatake = int(input())
        totalstick = totalstick - wannatake
